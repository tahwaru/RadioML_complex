...
plt.savefig('Plots/Loss' + str(snr_dB) + 'MAE_dBshuffledRadioML2016')
plt.show()
...
plt.title("MAE @shuffled RadioML2016, S(I)NR=" + str(snr_dB)+'dB')
plt.legend([pl1, pl2, pl3], ['Train', 'Validation', 'Test'])
...
plt.xlabel('Epochs')
plt.ylabel("(smoothed) Loss MAE@shuffled RadioML2016, S(I)NR=" + str(snr_dB) + 'dB')
plt.legend([pl1, pl2, pl3], ['Train', 'Validation', 'Test'])
...
plt.xlabel('Epochs')
plt.ylabel("(smoothed) MAE @shuffled RadioML2016, S(I)NR=" + str(snr_dB) + 'dB')
plt.legend([pl1, pl2, pl3], ['Train', 'Validation', 'Test'])
plt.savefig('Plots/Accuracy' + str(snr_dB) + 'Smooth_dBshuffledRadioML2016')
